...
public class P68_Must_ToDo_Hard {
    /* 
    ...
    public List<String> fullJustify(String[] words, int maxWidth) {
        ...
        while( i< words.length) {
            ...
            result.add(formatText(target, maxWidth, lastFlag));
        }
        return result;
    }
    ...
    String formatText(List<StringBuilder> target, int maxWidth, boolean lastFlag) {
        int count = 0;
