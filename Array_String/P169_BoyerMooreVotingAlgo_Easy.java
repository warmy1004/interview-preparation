...
public class P169_BoyerMooreVotingAlgo_Easy {
    /*
    ...
    void quicksort(int[] nums, int start, int end) {
        ...
        quicksort(nums, originalStart, end);
        quicksort(nums, start, originalEnd);
    }

    /*
     * Solution: Divide and conquer
     * time complexity: O(nlogn)
     * space complexity: O(logn) due to stack for recursive call
     */
    public int majorityElement(int[] nums) {
    ...
    int countInRange(int[] nums, int target, int start, int end) {
        int count = 0;
