...
public class P191_ToDo_Easy {
    ...
    public int hammingWeight(int n) {
        ...
        while(n!=0) {
            ...
            // Therefore, AND-ing the two numbers n and n-1 always flips the least significant 1-bit (right-most 1 bit) in n to 0, and keep all other bits the same.
            n &= (n-1);
            count++;
        }
        return count;
